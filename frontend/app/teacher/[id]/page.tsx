    ...
    return (
        <div>
            <BriefBlock
                ...
                imageUrl={teacher?.imageUrl ?? 'https://m.media-amazon.com/images/S/aplus-media-library-service-media/365e5edb-7b7f-415a-81c7-a848936e9e38.__CR0,0,300,300_PT0_SX300_V1___.jpg'}
                department="N/A"
                school="N/A"
            ...
            <div className="grid gap-5 grid-cols-10">
                ...
                <EventBlock id={params.id} classNames="col-span-3"/>
            </div>
        </div>
    )
}